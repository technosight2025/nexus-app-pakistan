...
interface EventManagerHeroProps {
  onSearch: (style: string, city: string) => void
}

export function EventManagerHero({ onSearch }: EventManagerHeroProps) {
  ...
  const QUICK_TAGS = ["Full-Service Planning", "Day-Of Coordination", "Corporate Seminars", "Luxury Weddings", "Private Parties"]
    ...
    <section className="relative bg-white border-b border-outline overflow-hidden py-12 md:py-20">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            <ShieldCheck className="w-4 h-4" /> Transparent Operations & Quality Check
          </motion.div>
          ...
          >
            Pakistan's Premier Wedding & Event Planners.
          </motion.h1>
          ...
          >
            Connect with verified theme designers, day-of coordinators, and luxury planners. Sync itineraries, review runsheets, and track budgets from one dashboard.
          </motion.p>
          ...
          >
            <div className="flex-1 flex items-center relative group px-2">
              ...
              <input
                type="text"
                placeholder="What planning style do you prefer? e.g. Day-Of..."
                value={style}
            ...
            >
              <Sparkles className="w-4 h-4" /> Find Planners
            </button>
          </motion.form>
