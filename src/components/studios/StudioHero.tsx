...
export function StudioHero({ onSearch }: StudioHeroProps) {
  ...
  const QUICK_TAGS = ["Cinematic Film", "Sound Stage", "Cyclorama Wall", "Dubbing Suite", "VFX Space"]
    ...
    <section className="relative bg-white border-b border-outline overflow-hidden py-12 md:py-20">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            <ShieldCheck className="w-4 h-4" /> Professional Spaces & Studios
          </motion.div>
          ...
          >
            Pakistan's Premium Production & Media Studios.
          </motion.h1>
          ...
          >
            Discover and book verified photography stages, sound suites, green screen halls, and high-end equipment rental packages.
          </motion.p>
          ...
          >
            <div className="flex-1 flex items-center relative group px-2">
              ...
              <input
                type="text"
                placeholder="What studio/space do you need? e.g. Sound Stage..."
                value={specialty}
            ...
            >
              <Sparkles className="w-4 h-4" /> Find Studios
            </button>
          </motion.form>
