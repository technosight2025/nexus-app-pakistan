          ...
          <div className="flex items-center gap-4 shrink-0">
            {pathname === "/business" ? (
              <Link 
                ...
                className="hidden md:block px-5 py-2 text-[10px] font-black uppercase tracking-widest rounded-full transition-colors border border-neutral-200 text-neutral-800 hover:bg-neutral-50"
              >
                Business Login
              </Link>
            ) : (
