        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 w-full h-full flex items-center justify-between relative">
          ...
          <div className="hidden xl:flex items-center justify-center flex-1 max-w-[720px] mx-8 relative">
            <div 
              ...
              className={`w-full h-14 bg-white border border-[#E5E7EB] hover:border-[#4F46E5] rounded-[40px] p-1 flex items-center transition-all duration-205 group relative ${
            ...
            >
              <form onSubmit={handleSearchSubmit} className="w-full flex items-center h-full">
                ...
                <button 
                  type="submit"
                  className="w-12 h-12 rounded-full bg-[#4F46E5] hover:bg-indigo-755 text-white flex items-center justify-center shrink-0 shadow-sm hover:scale-105 active:scale-95 transition-all duration-200 mr-1 cursor-pointer"
                >
          ...
          <div className="flex items-center gap-5 shrink-0">
            ...
            <Link href="/business">
              <span className="hidden lg:inline-flex items-center justify-center px-6 py-2.5 bg-[#4F46E5] hover:bg-indigo-700 text-white rounded-xl text-xs font-bold uppercase tracking-widest shadow-sm hover:-translate-y-0.5 active:translate-y-0 cursor-pointer transition-all duration-205">
            ...
            <div className="flex items-center gap-5">
                  ...
                  {activeDropdown === 'account' && (
                    ...
                    >
                      <div className="px-4 py-2 border-b border-slate-100 mb-2">
                        ...
                        <span className="inline-flex items-center gap-1 text-[8px] font-black uppercase text-green-655 bg-green-50 text-green-700 px-2 py-0.5 rounded-full mt-1.5">
              ...
              <button 
                ...
                className="xl:hidden p-2 hover:bg-[#EEF2FF] rounded-full text-slate-655 cursor-pointer"
              >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto space-y-6 scrollbar-hide">
                ...
                <div className="space-y-3 pb-8">
                  ...
                  <Link href="/business" onClick={() => setIsMobileDrawerOpen(false)} className="block text-sm font-bold text-teal-655 hover:text-teal-700 py-1">Become a Professional</Link>
