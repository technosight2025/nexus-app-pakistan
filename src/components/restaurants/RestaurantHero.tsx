...
export function RestaurantHero({ onSearch }: RestaurantHeroProps) {
  ...
  const QUICK_TAGS = ["Private Dining Room", "Rooftop Views", "Buffet Hall", "High Tea Cafe", "Mini Banquet"]
    ...
    <section className="relative bg-white border-b border-outline overflow-hidden py-12 md:py-20">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            <ShieldCheck className="w-4 h-4" /> Certified Dining Spaces
          </motion.div>
          ...
          >
            Pakistan's Premier Event-Friendly Restaurants.
          </motion.h1>
          ...
          >
            Book verified private dining suites, rooftops, high-tea cafes, and mini banquet halls. Secure custom menus, check setups, and book instantly.
          </motion.p>
          ...
          >
            <div className="flex-1 flex items-center relative group px-2">
              ...
              <input
                type="text"
                placeholder="What dining space do you need? e.g. Rooftop..."
                value={cuisine}
            ...
            >
              <Sparkles className="w-4 h-4" /> Find Dining
            </button>
          </motion.form>
