...
interface DecoratorHeroProps {
  onSearch: (style: string, city: string) => void
}

export function DecoratorHero({ onSearch }: DecoratorHeroProps) {
  ...
  const QUICK_TAGS = ["Floral Stage", "Modern Minimalist", "Traditional Mehndi", "Royal Luxury", "Ambient Lighting"]
    ...
    <section className="relative bg-white border-b border-outline overflow-hidden py-12 md:py-20">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            <ShieldCheck className="w-4 h-4" /> Professional Stage & Theme Designers
          </motion.div>
          ...
          >
            Pakistan's Premier Wedding & Event Decorators.
          </motion.h1>
          ...
          >
            Book verified floral decorators, stage constructors, theme planners, and ambient lighting crews. Protected by 3D render guarantees.
          </motion.p>
          ...
          >
            <div className="flex-1 flex items-center relative group px-2">
              ...
              <input
                type="text"
                placeholder="What decor style do you prefer? e.g. Floral..."
                value={style}
            ...
            >
              <Sparkles className="w-4 h-4" /> Find Decorators
            </button>
          </motion.form>
