...
export function EventManagerCTA() {
  return (
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 backdrop-blur-sm rounded-lg text-xs font-bold border border-white/10 mb-6">
                  <Sparkles className="w-3.5 h-3.5 text-yellow-300" /> Grow Your Event Brand
                </div>
                <h3 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
                  List Your Event Management Brand on NEXUS.
                </h3>
                <p className="text-primary-foreground/80 text-sm font-medium mb-8 max-w-md leading-relaxed">
                  Join Pakistan's premier hospitality and events marketplace. Reach high-budget weddings, coordinate with venues, and lock in direct client contracts.
                </p>
              </div>
              <button className="bg-white text-primary hover:bg-slate-50 font-bold rounded-xl h-12 px-6 w-max shadow-sm transition-transform hover:-translate-y-0.5 flex items-center gap-2 text-sm">
                Register as Event Planner <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </motion.div>
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-100 rounded-lg text-xs font-bold border border-outline mb-6">
                  <ClipboardList className="w-3.5 h-3.5 text-primary" /> Concept Development
                </div>
                <h3 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
                  Need an Expert Event Coordination Pitch?
                </h3>
                <p className="text-muted-foreground text-sm font-medium mb-8 max-w-md leading-relaxed">
                  Discuss with our verified event directors to spec theme layout designs, 3D pathway lighting renders, catering daigs, and vendor check-ins.
                </p>
              </div>
